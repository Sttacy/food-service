...
var _listMenu = _interopRequireDefault(require("../templates/listMenu.hbs"));
var _menu = _interopRequireDefault(require("../menu.json"));
require("../styles.css");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var menu = document.querySelector(".js-menu");
var menuCards = (0, _listMenu.default)(_menu.default);
menu.insertAdjacentHTML("afterbegin", menuCards);
},{"../templates/listMenu.hbs":"templates/listMenu.hbs","../menu.json":"menu.json","../styles.css":"styles.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
var b=require("../node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("html",require("../node_modules/parcel-bundler/src/builtins/loaders/browser/html-loader.js"));b.load([["listMenu.e3b2f5bb.html","templates/listMenu.hbs"]]).then(function(){require("js/list.js");});
